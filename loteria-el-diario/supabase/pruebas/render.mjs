...
const RUTAS = [
  ...
  ["/informe", ["Informe de gerencia", "Captura diaria"]],
  ["/informe?vista=semanal", ["Resumen semanal", "SEMANAS", "TOTALES DE LA SEMANA"]],
  ["/informe?vista=vendedor", ["Análisis de vendedores", "Historial por semana", "ACUMULADO"]],
  ["/informe?vista=financiera", ["Análisis financiero", "Resumen acumulado", "Neto por semestre", "Neto por día de la semana", "Detalle por semana"]],
