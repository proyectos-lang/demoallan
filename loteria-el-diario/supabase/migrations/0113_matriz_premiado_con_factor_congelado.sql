-- ===========================================================================
-- La matriz de captura por totales deduce el premiado con el factor CONGELADO.
--
-- La rejilla reabre cada casilla con lo APOSTADO (premios / factor). Ahora usa
-- el factor de la captura (`venta_total.factor_congelado`), para que reabra con
-- la misma cifra que se tecleó aunque el factor del vendedor haya cambiado
-- después. La CTE `capturado` pasa a exponer ese factor. Ver la 0107.
-- ===========================================================================
