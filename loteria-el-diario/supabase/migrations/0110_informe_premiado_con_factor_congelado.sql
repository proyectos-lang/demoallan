-- ===========================================================================
-- El informe de gerencia deduce el premiado con el factor CONGELADO.
--
-- El premiado de las capturas por totales se deducía con el factor vigente hoy;
-- ahora usa `venta_total.factor_congelado` —el factor de la captura— y sólo cae
-- al vigente si esa fila no lo tiene (capturas anteriores a la 0107 que el
-- backfill no resolvió). Ver la 0107 para el porqué. La firma no cambia.
-- ===========================================================================
